                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
                    <div class="card card-signup">
                        ...
                        <form class="form" method="post" action="register">
                            ...
                            <p class="text-divider">Hi ${username}, Wel come to the Retail POS</p>
                            <div class="content">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="form-group label-floating">
                                        ...
                                        <input type="text" name="posId" class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="footer text-center">
                                <input type="submit" class="btn btn-simple btn-primary btn-lg" value="Connect" />
                            </div>
                        </form>
                    </div>
                </div>
